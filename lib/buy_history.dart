    ...
    return Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            Center(
                child: Expanded(child: Text('Название автомобиля: ${shoppingCart[history_index].name}'
                ),
                )
            ),
            Center(
                child: Expanded(child: Text('Комплектация: ${shoppingCart[history_index].complex}'
                ),
                )
            ),
            Center(
